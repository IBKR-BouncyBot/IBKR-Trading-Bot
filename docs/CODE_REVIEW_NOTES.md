...
This file records the current review boundaries for v3.0.18. It is not a release changelog and should not be used instead of the behavioral guides.
...
- keeps the application and package version at v3.0.18 for documentation-only revisions within this release;
