...
This v4.0.0 test-only matrix contains 58 explicit scenario contracts across 54 CSV price-path files. It extends verification without changing `app/` or `main.py`.
