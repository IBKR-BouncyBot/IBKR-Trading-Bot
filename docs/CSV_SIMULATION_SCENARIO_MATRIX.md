...
This v3.0.17 test-only matrix contains 58 explicit scenario contracts across 54 CSV price-path files. It extends verification without changing `app/` or `main.py`.
