...
This document is the current functional description of the five-stage strategy in v3.0.17. It describes application decisions; IBKR remains authoritative for accepted order state and execution.
