...
def test_v221_version_strings():
    ...
    assert '# BouncyBot - IBKR Portable Trading Bot v3.0.19' in Path("README.md").read_text(encoding="utf-8")
    assert 'version = "3.0.19"' in Path("pyproject.toml").read_text(encoding="utf-8")
